...
if result.DownloadResult == nil {
return nil, errors.New("download: empty downloadResult")
}
downloadURL := result.DownloadResult.DownloadURL
if downloadURL == "" {
...
uploadURL := uploadResult.UploadResult.UploadURL
if uploadURL == "" {
...
if err := d.postAPI(pathGetDiskInfo, nil, "xml", &result); err != nil {
